...
docker build \
    ...
    -t <your-dockerhub-user>/sdcpp-restapi:cuda \
    .

# Tag with version for immutable reference
docker tag <your-dockerhub-user>/sdcpp-restapi:cuda <your-dockerhub-user>/sdcpp-restapi:0.2.0-cuda

# Push both
docker login
docker push <your-dockerhub-user>/sdcpp-restapi:cuda
docker push <your-dockerhub-user>/sdcpp-restapi:0.2.0-cuda
```
...
2. **Deploy a pod**:
   ...
   - Container Image: `<your-dockerhub-user>/sdcpp-restapi:cuda`
...
IMAGE="<your-dockerhub-user>/sdcpp-restapi:cuda"
...
Realized $/hr:  $0.25
Image:          <your-dockerhub-user>/sdcpp-restapi:0.2.0-cuda
